...
public class HelloWorldEndpoints {
   ...
   // Declare this method as a method available externally through Endpoints
    ...
    @ApiMethod(name ="greetByPeriodAdvanced", path = "greetByPeriodAdvanced", httpMethod = HttpMethod.GET)
    public HelloClass greetByPeriodAdvanced(@Named("name") String name,    @Named("period") String period){
        return new HelloClass(name, period);
    }
}
